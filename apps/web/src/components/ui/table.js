...
function Table(_a) {
    ...
    return (<div data-slot="table-container" className="relative w-full overflow-x-auto">
      <table data-slot="table" className={(0, utils_1.cn)("w-full caption-bottom text-xs", className)} {...props}/>
    </div>);
}
...
function TableHead(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (<th data-slot="table-head" className={(0, utils_1.cn)("text-foreground h-10 px-2 text-left align-middle font-medium whitespace-nowrap [&:has([role=checkbox])]:pr-0", className)} {...props}/>);
}
function TableCell(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (<td data-slot="table-cell" className={(0, utils_1.cn)("p-2 align-middle whitespace-nowrap [&:has([role=checkbox])]:pr-0", className)} {...props}/>);
}
function TableCaption(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (<caption data-slot="table-caption" className={(0, utils_1.cn)("text-muted-foreground mt-4 text-xs", className)} {...props}/>);
}
