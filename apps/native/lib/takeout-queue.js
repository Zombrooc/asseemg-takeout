...
var STORAGE_KEY = "takeout_pending_confirm";
...
function addToQueue(item) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getPendingQueue()];
                case 1:
                    list = _a.sent();
                    withDate = __assign(__assign({}, item), { created_at: new Date().toISOString() });
                    list.push(withDate);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    list = _a.sent();
                    next = list.filter(function (i) { return i.request_id !== requestId; });
...
function setQueue(list) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, async_storage_1.default.setItem(STORAGE_KEY, JSON.stringify(list))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
